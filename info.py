...
URL = "https://therock2.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://therock2.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://therock2.onrender.com/".format(FQDN)
else:
    URL = "https://therock2.onrender.com/".format(FQDN)
